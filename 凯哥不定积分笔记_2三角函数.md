...
$$
\begin{split}
\mathrm i^4\sin^4 x \cdot2^2\cos^2 x &= \left(y-\frac{1}{y}\right)^4\left(y+\frac{1}{y}\right)^2\cr
...
\begin{split}
I&:=\int \sin^4 x \cos^2 x \mathrm dx\cr
&=\frac{1}{4}\int\left(2\cos 6x-4\cos 4x - 2\cos 2x + 4\right)\mathrm dx\cr
&=\frac{1}{12}\sin 6x-\frac{1}{4}\sin 4x -\frac{1}{4}\sin 2x + x+C
\end{split}
$$
